...
const steps = [
  { num: "01", title: "Define your project", description: "Set genre, style, episode count, and target platforms. Synthos AI aligns all agents to your production parameters.", color: "border-indigo-500/40 bg-indigo-500/5" },
  ...
  { num: "04", title: "Render with SynthRender", description: "Your storyboard feeds directly into SynthRender. 48 scenes render in parallel across cloud GPU clusters.", color: "border-cyan-500/40 bg-cyan-500/5" },
