          ...
          <div className="glass rounded-2xl p-6 w-full max-w-2xl max-h-[85vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-5">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Powered by Mistral-7B on HuggingFace (free)</p>
              </div>
            ...
            {!generatedScript ? (
              <div className="space-y-4">
                ...
                <button onClick={generateScript}
                  ...
                  {generating
                    ? <span className="flex items-center justify-center gap-2"><Loader2 className="w-4 h-4 animate-spin" /> Writing script via Mistral-7B…</span>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 p-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                  ...
                  <p className="text-xs text-emerald-400">Script generated by Mistral-7B · Saved to database</p>
                </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          <div className="glass rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-3">
              <OpenClawBadge label="Mistral-7B · HuggingFace" />
            </div>
            <OpenClawMetricsBar metrics={[
              { label: "Script model",       value: "Mistral-7B-Instruct" },
