          ...
          <div className="glass rounded-2xl p-6 w-full max-w-2xl max-h-[85vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-5">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Powered by Llama-3.3-70B via OpenRouter</p>
              </div>
            ...
            {!generatedScript ? (
              <div className="space-y-4">
                ...
                <button onClick={generateScript}
                  ...
                  {generating
                    ? <span className="flex items-center justify-center gap-2"><Loader2 className="w-4 h-4 animate-spin" /> Writing script via Llama-3.3-70B…</span>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 p-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                  ...
                  <p className="text-xs text-emerald-400">Script generated by Llama-3.3-70B · Saved to database</p>
                </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          <div className="glass rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-3">
              <OpenClawBadge label="Llama-3.3-70B · OpenRouter" />
            </div>
            <OpenClawMetricsBar metrics={[
              { label: "Script model",       value: "Llama-3.3-70B" },
