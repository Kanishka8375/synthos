...
import { FolderOpen, Film, Cpu, Users, ArrowRight, Zap, Clock, Image as ImageIcon, FileText, Music2 } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div>
      <DashHeader
        title="Dashboard"
        description={userInfo?.studio_name ? `${userInfo.studio_name} — production overview` : "Your production studio overview"}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="lg:col-span-2 glass rounded-2xl overflow-hidden">
            ...
            <div className="divide-y divide-white/5">
              {userStats && userStats.projects === 0 ? (
                <div className="px-5 py-8 text-center">
                  <p className="text-xs text-gray-500 mb-2">No projects yet.</p>
                  <Link href="/projects" className="text-xs text-indigo-400 hover:text-indigo-300">Create your first project →</Link>
                </div>
              ) : (
                <div className="px-5 py-3 text-center">
                  <Link href="/projects" className="text-xs text-indigo-400 hover:text-indigo-300">View all {userStats?.projects ?? "your"} real projects →</Link>
                </div>
              )}
              {/* Quick link rows */}
              {[
                ...
                <Link key={p.title} href={p.href} className="flex items-center justify-between px-5 py-3 hover:bg-white/[0.03] transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <StatusBadge status={p.status as "Active"} />
                  </div>
                </Link>
              ))}
            </div>
